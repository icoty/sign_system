(function (i) {
    ...
    var l = i.fn.dataTable, o;
    var h = "undefined" !== typeof self && self || "undefined" !== typeof g && g || this.content;
    if ("undefined" === typeof h || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) o = void 0; else {
        var t = h.document.createElementNS("http://www.w3.org/1999/xhtml", "a"), J = "download" in t,
            K = /constructor/i.test(h.HTMLElement) || h.safari, A = /CriOS\/[\d]+/.test(navigator.userAgent),
            L = function (a) {
                ...
                d || (a = C(a));
                var b = this, d = "application/octet-stream" === a.type, e, f = function () {
        ...
        }, j.readyState = j.INIT = 0, j.WRITING = 1, j.DONE = 2, j.error = j.onwritestart = j.onprogress = j.onwrite = j.onabort = j.onerror = j.onwriteend =
    ...
    l.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5", text: function (a) {
            ...
            b[0].focus();
            b[0].select();
            var m = i(f).closest(".dt-button-info"), g = function () {
    ...
    l.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5", available: function () {
            ...
            }, c = c.buttons.exportData(b.exportOptions), m, k, d = function (a) {
                m = e + 1;
                k = n(f, "row", {attr: {r: m}});
                for (var b = 0,
                         c = a.length; b < c; b++) {
                    ...
                    if (!(null === a[b] || a[b] === p || "" === a[b])) {
                        a[b] = i.trim(a[b]);
                        for (var l = 0, o = H.length; l < o; l++) if (g = H[l], a[b].match && a[b].match(g.match)) {
                            j = a[b].replace(/[^\d\.\-]/g, "");
                            g.fmt && (j = g.fmt(j));
    ...
    l.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, c, d, b) {
            E(b);
            var a = c.buttons.exportData(b.exportOptions), e = [];
